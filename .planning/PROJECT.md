...
### v1.5 Podcasts (archived)

All requirements complete. See `.planning/milestones/v1.5-REQUIREMENTS.md`.

### v2.0 Browse Daemon Migration (archived)

9 phases shipped. See `.planning/milestones/v2.0-ROADMAP.md`.

### v2.1 Context Menu (archived)

2 phases shipped. See `.planning/milestones/v2.1-ROADMAP.md`.

### v2.2 Session Health (archived)

1 phase shipped (Phase 36). Session Health Monitoring + me/* Bundled Fallback.

### Active — v2.3 Library Integration

**Goal:** Spotify-Bibliothek in LMS Native Library integrieren + Standard-LMS-Menüeinträge im Context Menu

**Target features:**
- Liked Songs, Saved Albums, Followed Artists in LMS Native Library (OnlineLibraryBase/Importer.pm)
- Globale LMS-Suche für Spotify-Content
- Inkrementeller Sync via added_at Early-Exit
- Playlist-Import (opt-in, da über SpotOn-Menüs bereits browsebar)
- Standard-LMS-Menüeinträge im More-Menü neben SpotOn-Einträgen (GH #55)
...
- Online-Musiksammlung (Importer.pm) — ~~API-Quota im Dev Mode zu teuer~~ Widerlegt: me/tracks liefert volle Objekte, ~168 Calls für 2k-Library. **Moved to v2.3 scope.**
...
---
*Created: 2026-05-26*
*Last updated: 2026-06-30 — Milestone v2.3 started*
