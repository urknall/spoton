...
- [x] **Phase 1: Plugin Skeleton + Binary Foundation** - Plugin loads in LMS, correct manifest, binary scaffolding in place (completed 2026-05-27)
...
- [x] 01-02-PLAN.md -- Helper.pm (Binary-Discovery) + Settings.pm + basic.html Template
- [x] 01-03-PLAN.md -- Bin/-Verzeichnisstruktur, Test-Suite (6 Testdateien), LMS-Integration-Verifikation
- [x] 01-04-PLAN.md -- x86_64 Binary-Build + GitHub Actions CI fuer ARM-Cross-Compilation
