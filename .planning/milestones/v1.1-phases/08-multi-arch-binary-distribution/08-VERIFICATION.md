...
human_verification:
  ...
  - test: "Verify aarch64 hardware streaming (ARCH-09 — deferred by user)"
    ...
    result: "PASSED — confirmed 2026-06-04 on Pi 4 (aarch64, Debian 12 bookworm). SpotOn v1.1.2 installed via LMS custom repo. Both Browse and Connect mode stream audio successfully."
---
