...
// Phase 30: removed legacy --single-track, --connect, --browse modes
//
// Modes:
...
mod connect;  // connect.rs: LMS + HttpStreamSink used by unified.rs
mod browse;   // browse.rs: BrowseHttpSink + serve_track_request used by unified.rs
